...
document.querySelector('.reviews').textContent = `( ${profil.reviews_count} avis)`;
document.querySelector('.projects').textContent = `${profil.projects_completed} projets réslisés`
document.querySelector('.job-title').textContent = profil.profession;
document.querySelector('.experience').textContent = `${profil.experience_years} années d'experience`;
